---
title: "Behavioristické modely firmy — Simon, Cyert-March, Doyle"
course: mikk
type: topic
tags: [mikk, mikroekonomie, simon, cyert-march, doyle, behavior, satisficing]
sources: [raw/mikk/buchta.pdf, raw/mikk/Mikro KS prednaska 5 2026.pdf]
created: 2026-04-27
updated: '2026-04-27'
---
...
3. **Pokud ANO** → **Krok 3**: zvýšit aspirační úroveň, stanovit vyšší cíl (např. 110 mil. Kč).
4. **Pokud NE** → **Krok 4**: snížit aspirační úroveň, stanovit nižší cíl (např. 95 mil. Kč).
...
| Útvar | Cíle |
|-------|------|
| **Výrobáři** | plynulost výroby, neměnný objem produkce, neměnný sortiment finálních výrobků |
| **Zásobovači** | co nejužší sortiment dodávaného materiálu, jednorázové dodávky, dodržování limitu zásob |
| **Odbytáři** | co nejvíc prodat, co nejvíc utržit |
| **Marketingoví pracovníci** | uspokojit přání zákazníků, zvýšit pozici firmy na trhu, získat další odběratele |
| **Ekonomové** | efektivnost (ziskovost), maximalizace cash flow |
| **Technici** | zavádění nových technologií, nové výrobky, technická úroveň |
...
| # | Oblast | Konkretizace |
|---|--------|--------------|
| 1 | **Výroba** | plynulost nebo dosažení určité výše objemu produkce |
| 2 | **Zásoby** | absolutní úroveň nebo uspokojivé rozmezí — musí být dost pro provoz, nesmí vázat příliš prostředků |
| 3 | **Prodej** | v jednotkách produktu nebo dosažení požadovaných příjmů |
| 4 | **Podíl na trhu** | alternativa prodejů, indikátor relativní pozice |
| 5 | **Zisk** | ukazatel kompetentnosti vrcholového managementu (poměr zisku k nákladům, k investicím) |
...
| Extrémní cíl | Důsledek |
|--------------|----------|
| Pouze růst firmy | Akvizice za přemrštěné ceny → finanční tíseň |
| Pouze podíl na trhu | Cenové války → ztrátovost (např. Uber 2010s) |
| Pouze minimalizace rizika | Ztráta inovační schopnosti, postupný úpadek |
| Pouze výnos z akcie | Krátkodobý focus, podinvestování do R&D |
| Pouze kvalita produkce | Nadměrná cena, ztráta cenově citlivých zákazníků |
...
- **Akademičtí funkcionáři** vs. **řadoví učitelé** — **rozporné cíle**:
...
Behavioristické modely mají úzkou souvislost s **teorií her** — viz [[mikk-vezno-dilema-teorie-her|Vězňovo dilema a teorie her]].
...
- [[mikk-alternativni-cile-firmy|Alternativní cíle firmy]] — širší přehled neoklasických, manažerských a behavioristických teorií.
- [[mikk-zamestnanecka-firma-ward|Zaměstnanecká firma (Ward)]] — alternativní teorie firmy s primárním cílem maximalizace mzdy zaměstnance.
- [[mikk-vezno-dilema-teorie-her|Vězňovo dilema a teorie her]] — formální rámec sociálních her v Cyert-March.
- [[mikk-monopolisticka-konkurence|Monopolistická konkurence]] (včetně Galbraithovy teorie tržní moci a vyrovnávací moci).
- [[mikk-monopol-pokrocily|Monopol — pokročilá teorie]].
- [[mikk-vzorce-prehled|MikK — Přehled vzorců]].
- [[mikk-vzorove-zkousky|MikK — Vzorové zkoušky]].
